...
namespace VideoDownloaderUI
{
    public class AppSettings
    {
        ...
        public string  AccentTheme           { get; set; } = "teal";   // teal | purple | pink | blue | orange | green
    ...
    public static class SettingsManager
    {
        ...
        /// <summary>
        /// Returns the background/foreground colors for dark or light mode.
        /// windowBg, cardBg, logBg, inputBg, textFg, subFg, borderBg
        /// </summary>
        public static (string windowBg, string cardBg, string logBg, string inputBg,
                        string textFg,  string subFg,  string borderBg)
            GetAppThemePalette(string appTheme) => appTheme == "light"
                ? ("#EDEFFE", "#FFFFFF", "#F8F9FF", "#F3F4FD",
                   "#1A1A2E", "#666699", "#E0E3F5")
                : ("#0F111A", "#1E202E", "#141622", "#2C2E3E",
                   "#FFFFFF",  "#888888", "#2A2D45");
